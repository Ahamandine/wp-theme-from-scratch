...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220704_britcom_7426283d0e5059fd4924_20220704092639_archive.zip';
	const ARCHIVE_SIZE		 = '45507409';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '7426283-04092639';
    const SECONDARY_PACKAGE_HASH = 'a8ca2fe-04092639';
	const VERSION			 = '1.4.7';
